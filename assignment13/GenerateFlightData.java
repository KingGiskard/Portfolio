...
/**
 * <p>
 * This class will generate random flights for you to test. If you want to make
 ...
 * you are having a hard time generating files. It is not commented so if you
 * want an explanation you can come see me in office hours or send me a message
 * in canvas.
 * </P>
 *
 * <p>
 * My suggestion is to use this file to generate some random data then modify it
 * slightly to test an edge case. That way you have several other flights your
 * algorithm will have to check as well as the correct one.
 * </p>
 *
 * <p>
 * <b>USAGE:</b> You can use this class just by changing the commented global
 * variables at the top of the file. For students interested in what was done in
 * lab with the command line you can also compile it with <code>javac</code> and
 * give it 3 command-line parameters: (1)The number of edges you want in the
 * graph, (2)the number of nodes in the graph, and (3)the name of the file for
 * the .csv file to output to. Keep in mind dense graphs will have shorter paths
 * and sparce graphs may not have paths to every node.
 * </p>
 *
...
public class GenerateFlightData {
	...
	private static String filePath = "FlightTestCases/testfile1.csv";

	// EDITING ANYTHING BELOW THIS MAY SCREW UP MY CODE SO DO SO AT YOUR OWN
	// RISK.
	// BTW I do not care if you do I just wont be able to tell you why your
	// broke it
	// if you do.
	...
	private static ArrayList<String> airliners = new ArrayList<String>(
			Arrays.asList("AA", "DL", "EV", "HA", "MQ", "OO", "UA", "WN"));
	...
	public static void main(String[] args) {
		...
		try (PrintWriter writer = new PrintWriter(filePath)) {
			...
			for (int i = 0; i < edgeCount; i++) {
				...
				String s = origin + "," + destination + "," + airliner + "," + randomDepatureDelay + ","
						+ generateDivertedOrCanceled() + "," + estimatedFlightTime + "," + randomDistance + ","
	...
	// THIS IS COMMENTED OUT BECAUSE IT ISN'T USED LOCALLY
	/*
	 * private static int generateActualFlightTime(int estimatedFlightTime) {
	 * int plusOrMinusTime = r.nextInt(50); return estimatedFlightTime +
	 * (r.nextBoolean() ? - plusOrMinusTime : + plusOrMinusTime) ; }
	 */
